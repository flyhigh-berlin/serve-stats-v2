      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] flex flex-col">
        <DialogHeader className="flex-shrink-0">
          ...
          <div className="space-y-4 pt-2">
            {/* Row 1: Aces/Errors with symmetrical layout and proper mobile spacing */}
            <div className="flex justify-center">
              <div className="w-full max-w-xl">
                <div className="grid grid-cols-2 gap-2 sm:gap-4">
                  {/* Aces Column - Header above count, then icons */}
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <div className="flex items-center gap-1 sm:gap-2 w-full max-w-28 justify-center">
                  ...
                  {/* Errors Column - Header above count, then icons (manually mirrored) */}
                  <div className="flex flex-col items-center gap-2">
                    <div className="flex flex-col items-center gap-2">
