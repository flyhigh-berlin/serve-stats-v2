        ...
        <CardContent className="p-3">
          <div className="flex items-center justify-between">
            ...
            {!activeType ? (
              ...
              <div className="flex space-x-1 flex-shrink-0">
                {/* Quality buttons with shapes: square for fail, star for ace */}
                <Button 
                  variant="outline"
                  size="icon"
                  className={`h-8 w-8 p-0 ${getQualityColor("good")}`}
                  onClick={() => handleServeClick(activeType, "good")}
                >
                  {activeType === "fail" ? (
                    <Square className="h-6 w-6 flex items-center justify-center">
                ...
                <Button 
                  variant="outline"
                  size="icon"
                  className={`h-8 w-8 p-0 ${getQualityColor("neutral")}`}
                ...
                <Button 
                  variant="outline"
                  size="icon"
                  className={`h-8 w-8 p-0 ${getQualityColor("bad")}`}
